 ...
 */
export function generateQueryTag() {
 ...
 */
export function extractUuid(queryTag) {
 ...
 */
export function extractShortUuid(queryTag) {
 ...
 */
export function isValidQueryTag(queryTag) {
    return /^cdesk_[0-9a-f]{8}([0-9a-f]{8})?$/.test(queryTag);
}
//# sourceMappingURL=query-tag.js.map